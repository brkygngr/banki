...
public class TransactionControllerImpl implements TransactionController {
  ...
  @Override
  public ResponseEntity<?> transferMoney(final TransferMoneyRequest transferMoneyRequest,
  ...
  @Override
  public ResponseEntity<List<TransactionHistoryResponse>> accountHistory(final UUID accountId,
                                                                         final JwtAuthenticationToken authentication) {
    Jwt principal = (Jwt) authentication.getPrincipal();
